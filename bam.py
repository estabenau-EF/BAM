...
def ParseCmdLine():
    ...
    basinTide_ = path_join('data','Boundary','Basin_Tide_Boundary_2000_2026.csv')
    ...
    basinStageRunoff_ = path_join('data','Runoff',
    ...
    basinStage_ = path_join('data','Stage','DailyStage_1999-9-1_2026-4-30.csv')
    ...
    ET_ = path_join('data','ET','PET_1999-9-1_2026-4-30.csv')
    ...
    parser.add_argument('-msl', '--seasonalMSL',
                        ...
                        help    = 'Seasonal MSL: -msl ' + seasonalMSL_)
